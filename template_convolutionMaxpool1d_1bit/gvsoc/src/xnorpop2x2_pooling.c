...
//#define DEBUG
void __attribute__((always_inline)) xnorpop2x2_pooling(
...
//      asm volatile("":::"memory");
        ...
        uint8_t channel_increment= 2;
//        channel_increment ^= (- (out_channel!= (((ch_out)>>1) - 1)) ^ channel_increment) & channel_increment;
//        printf("%d] %d\n", channel_increment, output_offset1);
//        printf("OUT %x\n",*pOut2);
